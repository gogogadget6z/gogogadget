      ...
      >
        ...
        {items.length > 0 && (
          <div className="border-t border-[#2A2A2A] p-4 space-y-4 bg-[#1E1E1E]">
            ...
            {/* Bouton Carte Bancaire - Bleu Stripe */}
            <button
              onClick={handleStripeCheckout}
              disabled={isCheckingOut}
              className="w-full py-3 px-4 bg-[#0070f3] hover:bg-[#0060df] text-white font-bold rounded-lg transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
            >
              {isCheckingOut ? (
                <>
