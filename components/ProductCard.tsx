      ...
      <div className="p-3 sm:p-5">
        ...
        <div className="mt-4 pt-4 border-t border-[#D4AF37]/20 space-y-3">
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-[#0070f3] hover:bg-[#0060df] text-white font-bold text-sm rounded-lg transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
          >
            {isCheckingOut ? (
              <>
